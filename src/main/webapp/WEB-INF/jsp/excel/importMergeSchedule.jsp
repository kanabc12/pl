            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="col-md-2 col-md-offset-10">
                        <h4>
                            ...
                            <a href="${ctx}/excel/merge/schedule/download?filename=\upload\template\tmp_2014-2015_gamschedulemerge.xlsx"
                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" id="form"
                          action="${ctx}/excel/merge/schedule/import" method="post" enctype="multipart/form-data">
                        <pl:showMessage/>
