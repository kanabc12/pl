...
<div class="clearfix">
    <form:form id="editForm" method="post" commandName="model" cssClass="row-fluid form-horizontal form-inline">
        <div class="clearfix">
            <form:label path="title" cssStyle="col-sm-3 control-label no-padding-right">标题：</form:label>
            <form:input path="title" cssClass="validate[required,maxSize[100]]"/>
        </div>

        <div class="clearfix">
            <form:label path="startDate"  cssStyle="col-sm-3 control-label no-padding-right">开始日期：</form:label>
        ...
        <div class="clearfix">
            <form:label path="length"  cssStyle="col-sm-3 control-label no-padding-right">持续天数：</form:label>
        ...
        <div class="clearfix">
            <form:label path="startTime" cssStyle="col-sm-3 control-label no-padding-right">开始时间：</form:label>
            <span class="input-append date">
        ...
        <div class="clearfix">
            <form:label path="endTime"  cssStyle="col-sm-3 control-label no-padding-right">结束时间：</form:label>
            <span class="input-append date">
        ...
        <div class="clearfix">
            <form:label path="details"  cssStyle="col-sm-3 control-label no-padding-right">备注：</form:label>
            <form:textarea path="details" cssClass="validate[maxSize[500]]"/>
        </div>


        <div class="clearfix">
            <form:label path="backgroundColor" cssStyle="col-sm-3 control-label no-padding-right">背景颜色：</form:label>
