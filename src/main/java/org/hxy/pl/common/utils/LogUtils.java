package org.hxy.pl.common.utils;
...
public class LogUtils {
    ...
    public static final Logger ERROR_LOG = LoggerFactory.getLogger("pl-error");
    public static final Logger ACCESS_LOG = LoggerFactory.getLogger("pl-access");
